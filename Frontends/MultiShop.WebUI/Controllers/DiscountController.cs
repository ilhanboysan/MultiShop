...
namespace MultiShop.WebUI.Controllers
{
    public class DiscountController : Controller
    {
        ...
        public async Task<IActionResult> ConfirmDiscountCoupon(string code)
        {
            ...
            var totalPriveWithTax = basketValues.TotalPrice + basketValues.TotalPrice / 100 * 10;
            var totalNewPriceWithDiscount = totalPriveWithTax - (totalPriveWithTax / 100 * values);
